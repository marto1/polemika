...
# -*- coding: utf-8 -*-
"""
Original code taken from recepie on github.

Scripts that generates a sound "fingerprint" from a file
using an algorithm.
...
def sum_chunks(string, chunk):
    res = []
    for c in inchunks(string, chunk):
...
class Voice(object):
    def __init__(self, note, length):
        ...
        self.adsr = ADSREnvelope(0.1, 0.4, 0.7, 3.0)
